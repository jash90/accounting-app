...
export const apptaxTheme: Theme = {
  ...
  colors: {
    light: {
      ...
      chart5: '170 53% 92%',
      // Sidebar - Navy blue
      sidebarBackground: '214 52% 15%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '209 90% 40%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '214 45% 22%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '214 40% 25%',
      sidebarRing: '209 90% 40%',
    },
    dark: {
      ...
      chart5: '340 75% 55%',
      // Sidebar - Navy blue
      sidebarBackground: '214 52% 12%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '212 64% 57%',
      sidebarPrimaryForeground: '214 52% 10%',
      sidebarAccent: '214 32% 18%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '214 32% 22%',
      sidebarRing: '170 100% 37%',
    },
  },
  preview: {
    light: {
...
export const flowbooksTheme: Theme = {
  ...
  colors: {
    light: {
      ...
      chart5: '0 84% 60%',
      // Sidebar - Indigo
      sidebarBackground: '243 75% 25%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '239 84% 67%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '243 65% 32%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '243 55% 35%',
    ...
    dark: {
      ...
      chart5: '0 84% 70%',
      // Sidebar - Deep Indigo
      sidebarBackground: '243 75% 18%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '239 84% 67%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '243 55% 25%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '243 45% 28%',
      sidebarRing: '239 84% 67%',
    },
  },
  preview: {
...
export const oceanTheme: Theme = {
  ...
  colors: {
    light: {
      ...
      chart5: '190 60% 70%',
      // Sidebar - Ocean blue
      sidebarBackground: '200 60% 22%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '199 89% 48%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '200 50% 28%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '200 45% 32%',
    ...
    dark: {
      ...
      chart5: '340 75% 55%',
      // Sidebar - Deep ocean
      sidebarBackground: '200 55% 14%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '199 89% 55%',
      sidebarPrimaryForeground: '200 50% 8%',
      sidebarAccent: '200 45% 20%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '200 40% 24%',
      sidebarRing: '175 84% 45%',
    },
  },
  preview: {
    light: {
...
export const forestTheme: Theme = {
  ...
  colors: {
    light: {
      ...
      sidebarBackground: '150 40% 15%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '142 71% 45%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '150 35% 22%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '150 30% 25%',
    ...
    dark: {
      ...
      chart5: '60 70% 60%',
      // Sidebar - Deep forest
      sidebarBackground: '150 40% 8%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '142 71% 50%',
      sidebarPrimaryForeground: '150 40% 6%',
      sidebarAccent: '150 30% 14%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '150 30% 16%',
      sidebarRing: '84 85% 50%',
    },
  },
  preview: {
    light: {
...
export const sunsetTheme: Theme = {
  ...
  colors: {
    light: {
      ...
      chart5: '35 85% 60%',
      // Sidebar - Warm amber
      sidebarBackground: '20 60% 18%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '24 95% 53%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '20 50% 25%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '20 45% 28%',
    ...
    dark: {
      ...
      chart5: '35 85% 65%',
      // Sidebar - Deep amber
      sidebarBackground: '20 55% 12%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '24 95% 58%',
      sidebarPrimaryForeground: '24 40% 6%',
      sidebarAccent: '20 45% 18%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '20 40% 20%',
      sidebarRing: '45 93% 52%',
    },
  },
  preview: {
    light: {
...
export const midnightTheme: Theme = {
  ...
  colors: {
    light: {
      ...
      chart5: '250 80% 60%',
      // Sidebar - Purple
      sidebarBackground: '270 55% 20%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '271 91% 65%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '270 45% 28%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '270 40% 32%',
    ...
    dark: {
      ...
      chart5: '250 80% 65%',
      // Sidebar - Deep purple
      sidebarBackground: '270 55% 12%',
      sidebarForeground: '0 0% 95%',
      sidebarPrimary: '271 91% 70%',
      sidebarPrimaryForeground: '270 50% 5%',
      sidebarAccent: '270 45% 18%',
      sidebarAccentForeground: '0 0% 95%',
      sidebarBorder: '270 40% 22%',
