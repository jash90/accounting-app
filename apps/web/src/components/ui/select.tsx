...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'ring-offset-background placeholder:text-muted-foreground focus:ring-primary/20 focus:border-primary flex h-11 w-full items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm transition-all duration-200 focus:ring-2 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-50 disabled:opacity-50 [&>span]:line-clamp-1',
      className
    )}
    {...props}
  >
