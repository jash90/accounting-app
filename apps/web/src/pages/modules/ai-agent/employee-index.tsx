    ...
    <div className="container mx-auto space-y-6 p-6">
      ...
      <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
        ...
        <Card className="bg-muted border-0">
          <CardHeader>
            <CardTitle className="text-foreground">Funkcje</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              <CheckCircle2 className="text-accent mt-0.5 h-5 w-5 flex-shrink-0" />
              <div>
                <p className="text-foreground font-medium">Historia rozmów</p>
                <p className="text-muted-foreground text-sm">
            ...
            <div className="flex items-start gap-3">
              <CheckCircle2 className="text-accent mt-0.5 h-5 w-5 flex-shrink-0" />
              <div>
                <p className="text-foreground font-medium">Zawsze dostępny</p>
