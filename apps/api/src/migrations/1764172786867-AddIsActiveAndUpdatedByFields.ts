...
export class AddIsActiveAndUpdatedByFields1764172786867 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "client_field_definitions" ADD "isActive" boolean NOT NULL DEFAULT true`
    );
    await queryRunner.query(
      `ALTER TABLE "client_custom_field_values" ADD "isActive" boolean NOT NULL DEFAULT true`
    );
    await queryRunner.query(
      `ALTER TABLE "client_icons" ADD "isActive" boolean NOT NULL DEFAULT true`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "clients" ADD CONSTRAINT "FK_a04d443b4a49fad8843337faa1e" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "clients" DROP CONSTRAINT "FK_a04d443b4a49fad8843337faa1e"`
    );
