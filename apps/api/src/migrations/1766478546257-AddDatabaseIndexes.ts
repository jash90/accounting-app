...
export class AddDatabaseIndexes1766478546257 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        const companiesOwnerFK = companiesTable?.foreignKeys.find(
            fk => fk.columnNames.includes("ownerId")
        );
        const usersCompanyFK = usersTable?.foreignKeys.find(
            fk => fk.columnNames.includes("companyId")
        );
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_b48860677afe62cd96e1265948" ON "public"."clients" ("email") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_0f760a14ed395d73bbbe688764" ON "public"."clients" ("zusStatus") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_62c34340705568e5b02222d4f2" ON "public"."clients" ("taxScheme") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_72732477bbddafce14380fd91d" ON "public"."clients" ("vatStatus") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_dad21d0dbcd0c984f479599f39" ON "public"."clients" ("employmentType") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_11858a8861bfe7496d663ffd05" ON "public"."clients" ("companyId", "name") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_21aa72858a258ab9a71969c7bf" ON "public"."clients" ("companyId", "isActive") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_605e81319be9823d9666a1b43e" ON "public"."companies" ("isActive") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_a58fba747b0d4bc3fdfa6ad250" ON "public"."companies" ("isSystemCompany") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_6dcdcbb7d72f64602307ec4ab3" ON "public"."companies" ("ownerId") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_ace513fa30d485cfd25c11a9e4" ON "public"."users" ("role") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_ce9dccc3162cbe075e0ab77108" ON "public"."users" ("companyId", "isActive") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_6f9395c9037632a31107c8a9e5" ON "public"."users" ("companyId") `);
