...
export class AddTasksModule1768644507694 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tasks_status_enum" AS ENUM('backlog', 'todo', 'in_progress', 'in_review', 'done', 'cancelled')`);
        await queryRunner.query(`CREATE TYPE "public"."tasks_priority_enum" AS ENUM('urgent', 'high', 'medium', 'low', 'none')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_1b845a1166502a1f9ee0969909" ON "tasks" ("companyId", "isActive") `);
        await queryRunner.query(`CREATE INDEX "IDX_99bfa7a6c5aaca173a6e1ac518" ON "tasks" ("companyId", "parentTaskId") `);
        await queryRunner.query(`CREATE INDEX "IDX_62dc2e225697b27d7977b0628d" ON "tasks" ("companyId", "priority") `);
        await queryRunner.query(`CREATE INDEX "IDX_35a9e17513f948604f159200e8" ON "tasks" ("companyId", "sortOrder") `);
        await queryRunner.query(`CREATE INDEX "IDX_21a27750732cb594800c39bb26" ON "tasks" ("companyId", "dueDate") `);
        await queryRunner.query(`CREATE INDEX "IDX_b2f457b10329c90b0aefcc69a9" ON "tasks" ("companyId", "clientId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b6fa36b8d6309a371ec9c4b3db" ON "tasks" ("companyId", "assigneeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_24927e51f485d7ad12fcbfd93e" ON "tasks" ("companyId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_683ad3f76f2544e5115afec26d" ON "tasks" ("companyId") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_4b0c8537af524732c743b65c0a" ON "task_labels" ("companyId", "name") `);
        await queryRunner.query(`CREATE INDEX "IDX_3278c2bc576fa2929295a45306" ON "task_labels" ("companyId") `);
        await queryRunner.query(`CREATE TABLE "task_label_assignments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "taskId" uuid NOT NULL, "labelId" uuid NOT NULL, "assignedById" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_41eea57a8d486e201a364a183b9" UNIQUE ("taskId", "labelId"), CONSTRAINT "PK_abea4da017c176df05fda3187fa" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_bcd0dab201bbcb97ff0f341dd1" ON "task_label_assignments" ("labelId") `);
        await queryRunner.query(`CREATE INDEX "IDX_132210971f5f0117d0c72db92c" ON "task_label_assignments" ("taskId") `);
        await queryRunner.query(`CREATE TYPE "public"."task_dependencies_dependencytype_enum" AS ENUM('blocks', 'blocked_by', 'relates_to')`);
        ...
        await queryRunner.query(`ALTER TYPE "public"."module_source_enum" RENAME TO "module_source_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."modules_source_enum" AS ENUM('file', 'database', 'legacy')`);
        await queryRunner.query(`ALTER TABLE "modules" ALTER COLUMN "source" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "modules" ALTER COLUMN "source" TYPE "public"."modules_source_enum" USING "source"::"text"::"public"."modules_source_enum"`);
        ...
        await queryRunner.query(`ALTER TABLE "tasks" ADD CONSTRAINT "FK_683ad3f76f2544e5115afec26d2" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tasks" ADD CONSTRAINT "FK_4e7cd3aff0dbd7708e02b14ecb8" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "task_labels" ADD CONSTRAINT "FK_3278c2bc576fa2929295a453064" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_labels" ADD CONSTRAINT "FK_d8a5323ba3609b3464c0a3a5919" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_label_assignments" ADD CONSTRAINT "FK_132210971f5f0117d0c72db92c4" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_label_assignments" ADD CONSTRAINT "FK_bcd0dab201bbcb97ff0f341dd1a" FOREIGN KEY ("labelId") REFERENCES "task_labels"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_label_assignments" ADD CONSTRAINT "FK_00fc112cf2e549b1aa09e9c2e74" FOREIGN KEY ("assignedById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_dependencies" ADD CONSTRAINT "FK_70371fdc2193845ef4feb9fb879" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_dependencies" ADD CONSTRAINT "FK_e94ede407a522714514c8471a81" FOREIGN KEY ("dependsOnTaskId") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "task_dependencies" ADD CONSTRAINT "FK_b597fefabfc03d5a6bf34330fa9" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "task_comments" ADD CONSTRAINT "FK_a57898470720b4fa4fa5064b501" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task_dependencies" DROP CONSTRAINT "FK_b597fefabfc03d5a6bf34330fa9"`);
        await queryRunner.query(`ALTER TABLE "task_dependencies" DROP CONSTRAINT "FK_e94ede407a522714514c8471a81"`);
        await queryRunner.query(`ALTER TABLE "task_dependencies" DROP CONSTRAINT "FK_70371fdc2193845ef4feb9fb879"`);
        await queryRunner.query(`ALTER TABLE "task_label_assignments" DROP CONSTRAINT "FK_00fc112cf2e549b1aa09e9c2e74"`);
        await queryRunner.query(`ALTER TABLE "task_label_assignments" DROP CONSTRAINT "FK_bcd0dab201bbcb97ff0f341dd1a"`);
        await queryRunner.query(`ALTER TABLE "task_label_assignments" DROP CONSTRAINT "FK_132210971f5f0117d0c72db92c4"`);
        await queryRunner.query(`ALTER TABLE "task_labels" DROP CONSTRAINT "FK_d8a5323ba3609b3464c0a3a5919"`);
        await queryRunner.query(`ALTER TABLE "task_labels" DROP CONSTRAINT "FK_3278c2bc576fa2929295a453064"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."module_source_enum_old" AS ENUM('file', 'database', 'legacy')`);
        await queryRunner.query(`ALTER TABLE "modules" ALTER COLUMN "source" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "modules" ALTER COLUMN "source" TYPE "public"."module_source_enum_old" USING "source"::"text"::"public"."module_source_enum_old"`);
        await queryRunner.query(`ALTER TABLE "modules" ALTER COLUMN "source" SET DEFAULT 'legacy'`);
        await queryRunner.query(`DROP TYPE "public"."modules_source_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."module_source_enum_old" RENAME TO "module_source_enum"`);
        await queryRunner.query(`ALTER TABLE "companies" ADD "notificationFromEmail" character varying`);
