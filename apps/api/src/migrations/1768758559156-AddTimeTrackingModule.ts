...
export class AddTimeTrackingModule1768758559156 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."time_entries_status_enum" AS ENUM('draft', 'submitted', 'approved', 'rejected', 'billed')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "time_projects" ADD CONSTRAINT "FK_97bdbb339879ea6703254a059b6" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" ADD CONSTRAINT "FK_88deb7df78583769f481908f088" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" ADD CONSTRAINT "FK_d1b452d7f0d45863303b7d30000" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" ADD CONSTRAINT "FK_54122708049eec426cbca8afbe9" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" ADD CONSTRAINT "FK_8cfb57662e88d7c65010311661d" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "time_entries" ADD CONSTRAINT "FK_fd757c406c5fb64febea3995dce" FOREIGN KEY ("approvedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "time_settings" ADD CONSTRAINT "FK_020e3cb781b95818f8ebaaaceb1" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "time_settings" ADD CONSTRAINT "FK_51fbe575f737f3439a3271a3898" FOREIGN KEY ("updatedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "time_settings" DROP CONSTRAINT "FK_51fbe575f737f3439a3271a3898"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_settings" DROP CONSTRAINT "FK_020e3cb781b95818f8ebaaaceb1"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" DROP CONSTRAINT "FK_93b21f91d7e795e367643bc3b8d"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" DROP CONSTRAINT "FK_fd757c406c5fb64febea3995dce"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "time_entries" DROP CONSTRAINT "FK_54122708049eec426cbca8afbe9"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" DROP CONSTRAINT "FK_d1b452d7f0d45863303b7d30000"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_entries" DROP CONSTRAINT "FK_88deb7df78583769f481908f088"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_projects" DROP CONSTRAINT "FK_97bdbb339879ea6703254a059b6"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_projects" DROP CONSTRAINT "FK_197fdc9a4fa3ab18a603139960a"`
    );
    await queryRunner.query(
      `ALTER TABLE "time_projects" DROP CONSTRAINT "FK_68d2c5fcfba9c53a1a950ef53fc"`
    );
